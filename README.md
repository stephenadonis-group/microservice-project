...
![image.png](images/steveshop 1.JPG)
...
helmCharts:
  - name: boutique-app
    repo: oci://ghcr.io/stephenadonis-group/onlineboutique
    version: 0.10.5
...
spec:
  ...
  applicationRefs:
    - namePattern: "boutique-*"
      ...
      images:
        - alias: adservice
          imageName: ghcr.io/stephenadonis-group/adservice

        - alias: cartservice
          imageName: ghcr.io/stephenadonis-group/cartservice

        - alias: checkoutservice
          imageName: ghcr.io/stephenadonis-group/checkoutservice

        - alias: currencyservice
          imageName: ghcr.io/stephenadonis-group/currencyservice

        - alias: emailservice
          imageName: ghcr.io/stephenadonis-group/emailservice

        - alias: frontend
          imageName: ghcr.io/stephenadonis-group/frontend

        - alias: paymentservice
          imageName: ghcr.io/stephenadonis-group/paymentservice

        - alias: productcatalogservice
          imageName: ghcr.io/stephenadonis-group/productcatalogservice

        - alias: recommendationservice
          imageName: ghcr.io/stephenadonis-group/recommendationservice

        - alias: shippingservice
          imageName: ghcr.io/stephenadonis-group/shippingservice

        - alias: loadgenerator
          imageName: ghcr.io/stephenadonis-group/loadgenerator
```
...
NAME               HOSTNAMES                   AGE
grafana-route      ["grafana.steveshop.net"]      30m
prometheus-route   ["prometheus.steveshop.net"]   41s
```
